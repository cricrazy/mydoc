@echo off
rem open command line, browse to this bat file, type, "banner printstr standard "Cool text" | clip. 
rem It create a ascii text and copy it to the clipboard

rem   __  __           _                              _   _
rem  |  \/  |   __ _  (_)  _ __         ___    __ _  | | | |
rem  | |\/| |  / _` | | | | '_ \       / __|  / _` | | | | |
rem  | |  | | | (_| | | | | | | |     | (__  | (_| | | | | |
rem  |_|  |_|  \__,_| |_| |_| |_|      \___|  \__,_| |_| |_|
rem 
rem                   _   _       _                                                 _               _                        _           _           _                      _                         _                      _       _                   _     _            ___                    _                      _              _   _
rem    ___    __ _  | | | |     | |__     __ _   _ __    _ __     ___   _ __      | |__     __ _  | |_       _ __    _ __  (_)  _ __   | |_   ___  | |_   _ __       ___  | |_    __ _   _ __     __| |   __ _   _ __    __| |     | |_    ___  __  __ | |_  (_)  _ __    / _ \   _   _    ___   | |_    ___   ___      | |       ___  | | (_)  _ __
rem   / __|  / _` | | | | |     | '_ \   / _` | | '_ \  | '_ \   / _ \ | '__|     | '_ \   / _` | | __|     | '_ \  | '__| | | | '_ \  | __| / __| | __| | '__|     / __| | __|  / _` | | '_ \   / _` |  / _` | | '__|  / _` |     | __|  / _ \ \ \/ / | __| | | | '_ \  | | | | | | | |  / _ \  | __|  / _ \ / __|     | |      / __| | | | | | '_ \
rem  | (__  | (_| | | | | |     | |_) | | (_| | | | | | | | | | |  __/ | |     _  | |_) | | (_| | | |_      | |_) | | |    | | | | | | | |_  \__ \ | |_  | |        \__ \ | |_  | (_| | | | | | | (_| | | (_| | | |    | (_| |     | |_  |  __/  >  <  | |_  | | | | | | | |_| | | |_| | | (_) | | |_  |  __/ \__ \     | |     | (__  | | | | | |_) |
rem   \___|  \__,_| |_| |_|     |_.__/   \__,_| |_| |_| |_| |_|  \___| |_|    (_) |_.__/   \__,_|  \__|     | .__/  |_|    |_| |_| |_|  \__| |___/  \__| |_|        |___/  \__|  \__,_| |_| |_|  \__,_|  \__,_| |_|     \__,_|      \__|  \___| /_/\_\  \__| |_| |_| |_|  \__\_\  \__,_|  \___/   \__|  \___| |___/     | |      \___| |_| |_| | .__/
rem                                                                                                         |_|                                                                                                                                                                                                         |_|                    |_|
rem  call banner.bat printstr standard "text" | clip 
rem  creates a ascii banner and copies it to the clipboard
rem 
if "%~1" neq "" (
